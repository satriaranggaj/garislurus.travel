    ...
    <section id="core-value">
        <div class="container">
            <div class="title">
                <center>
                    <h2 class="font-heading">
                        TRAVEL UMROH INSYAALLAH AMANAH PERCAYAKAN PADA GARISLURUS TRAVEL
                    </h2>
                </center>
            </div>
            <div class="content-value">
                <div class="card-content">
                   ...
                   <div class="title-desc">
                    ...
                    <div class="desc">
                        <p>
                            Memiliki izin resmi, Penyelenggara Perjalanan Umrah (Izin PPIU) Keputusan Menteri Agama Republik Indonesia No. 815 Tahun 2019 dan Izin PIHK No. 915 Tahun 2020.
                        </p>
                    </div>
                   </div>
                </div>
                <div class="card-content">
                    ...
                    <div class="title-desc">
                     ...
                     <div class="desc">
                         <p>
                            Garislurus juga bekerja sama dengan Wfood Al-Bait sebagai Syariah yang berwenang untuk mengelola operasional umrah di Kerajaan Arab Saudi.
                         </p>
                     </div>
                    </div>
                 </div>
                 <div class="card-content">
                    ...
                    <div class="title-desc">
                     ...
                     <div class="desc">
                         <p>
                            Garislurus memiliki ekosistem ticketing penerbangan dan hotel mandiri, InsyaAllah akan memberikan pelayanan yang maksimal
                         </p>
                     </div>
                    </div>
                 </div>
                 <div class="card-content">
                    ...
                    <div class="title-desc">
                     ...
                     <div class="desc">
                         <p>
                            InsyaAllah Fasilitas Nyaman, mulai dari transportasi sampai akomodasi.
                         </p>
                     </div>
                    </div>
                 </div>
